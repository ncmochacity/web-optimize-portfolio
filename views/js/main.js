...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    var pizzaQuery = document.querySelectorAll(".randomPizzaContainer");
    for (var i = 0; i < pizzaQuery.length; i++) {
      pizzaQuery[i].style.width = newwidth;
    }
  }
...
function updatePositions() {
  ...
  var topCal = (document.body.scrollTop / 1250);
  for (var i = 0; i < items.length; i++) {
    var phase = Math.sin( topCal+ (i % 5));
    var slideLeft = items[i].basicLeft + 100 * phase + 'px';
