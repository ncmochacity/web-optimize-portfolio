...
String.prototype.capitalize = function() {
 ...
 //slice method returns a new copy of extracted elements at a specified index position
};
 ...
 switch (x) {
  ...
  case "whimsical":
   var whimsy = ["whimsical", "silly", "drunken", "goofy", "funny", "weird", "strange", "odd", "playful", "clever", "boastful", "breakdancing",
    "hilarioxus", "conceited", "happy", "comical", "curious", "peculiar", "quaint", "quirky", "fancy", "wayward", "fickle", "yawning", "sleepy",
...
function logAverageFrame(times) { // times is the array of User Timing measurements from updatePositions()
 ...
 var sum = 0;
 for (var i = numberOfEntries - 1; i + 11 > numberOfEntries; i--) {
